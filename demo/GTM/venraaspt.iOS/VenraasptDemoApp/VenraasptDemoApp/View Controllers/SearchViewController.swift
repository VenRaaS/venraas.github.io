...
class SearchViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func loadView() {
        ...
        let edmButton = UIButton(frame: CGRect(x: 331, y: 80, width: 83, height: 40))
    ...
    override func viewDidLoad() {
        ...
        Venraaspt.mInstance.ven_search(keyword: "iPhone")

        Venraaspt.mInstance.ven_recomd(recPos: "sep", recType: "ClickStream", rowItems: 10) {  (completion) in

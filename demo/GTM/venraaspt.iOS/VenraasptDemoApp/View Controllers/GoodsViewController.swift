...
class GoodsViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        Venraaspt.mInstance.ven_goods(categoryCode: StorageData.mInstance.cid, goodsId: StorageData.mInstance.gid, keyword: StorageData.mInstance.keyword, fromRec: StorageData.mInstance.recomd_id)

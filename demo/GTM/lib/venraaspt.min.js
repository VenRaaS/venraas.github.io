...
var venraastool = {
    ...
    //新增檢查paramJson.ven_guid是否有存在且有值
    var ven_guid = "";
    if ((paramJson.ven_guid == null) || (paramJson.ven_guid == "")) {
      ...
      ven_guid = paramJson.ven_guid
    }

    //新增檢查paramJson.ven_guid是否有存在且有值
    var ven_session = "";
    if ((paramJson.ven_session == null) || (paramJson.ven_session == "")) {
      ...
      ven_session = paramJson.ven_session;
    }

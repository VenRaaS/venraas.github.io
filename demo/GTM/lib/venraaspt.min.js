...
var venraastool = {
	...
	recomd: function(paramJson, cbf) {
		...
		if ("" == ven_guid) {
			...
			xhr_guid.setRequestHeader("Content-type", "application/json; charset=UTF-8");
			...
			try {
				if (this.readyState == 4 && this.status == 200) {
					...
					xhr_session.open("GET", url_guid, true);
					xhr_session.setRequestHeader("Content-type", "application/json; charset=UTF-8");
					...
					try {
						if (this.readyState == 4 && this.status == 200) {
							...
							venraasxhr.open('POST', url_recomd, true);
							venraasxhr.setRequestHeader("Content-type","application/json; charset=UTF-8");
							venraasxhr.withCredentials = true;

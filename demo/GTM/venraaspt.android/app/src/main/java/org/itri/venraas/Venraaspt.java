...
public class Venraaspt {
    ...
    private final String serverLog = "apid.venraas.tw";
    //private final String serverLog = "apid.friday.tw";
    private final String apiUuid = "/venapis/vengu";
    private final String apiLog = "/venapis/log";
    private final String serverHermes = "apih.venraas.tw";
    //private final String serverHermes = "apih.friday.tw";
    ...
    public void ven_init(String token, final String domain, String clientHost, String topHost) {
        Log.i("[ven_init]", "token='" + token + "', domain='" + domain + "'");
        this.token = token;
        this.domain = domain;
